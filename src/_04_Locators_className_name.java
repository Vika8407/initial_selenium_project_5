...
public class _04_Locators_className_name {
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement grapesItem = driver.findElement(By.id("item_grapes"));
            ...
            if (orangeItem.isDisplayed()) System.out.println("Kiwi item validation is PASSED");
            else System.out.println("Kiwi item validation is FAILED");

            if (grapesItem.isDisplayed()) System.out.println("Kiwi item validation is PASSED");
            else System.out.println("Kiwi item validation is FAILED");
        } catch (Exception e){
